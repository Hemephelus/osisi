...
export default function Root() {
  return (
    <div className="bg-pri min-h-screen text-sec pri-font grid grid-rows-[auto,1fr] font-sora">
      <nav className="p-3 flex justify-between shadow-xl items-center bg-[#ffffff10] w-full">
        <Link to={"/"}>
